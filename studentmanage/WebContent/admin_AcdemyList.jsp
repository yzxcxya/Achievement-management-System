...
<div class="x-body">
  <form class="layui-form x-center" name="frm" action="AcdemyList" style="width:85%">
  ...
  <div class="tools">
    <ul class="toolbar">
      ...
      <li onclick="user_management_add('添加用户','acdemyAdd.jsp','600','500')"><span><img src="images/t01.png" /></span>添加</li>
    </ul>
    ...
    <tbody>
      <c:forEach items="${list}"	var="bean">		
					<tr>
						...
						<td>
						<ul class="toolbar">
      					 <li onclick="user_management_edit('用户编辑','AcdemyEdit?acdemyId=${bean.acdemyId}','600','500')"><span><img src="images/t02.png" /></span>修改</li>
      					 <li onclick="queren(${bean.acdemyId })"><span><img src="images/t03.png" /></span>删除</li>
    					</ul></td>
					</tr>
			</c:forEach>
    </tbody>
