...
<form role="form" method="post" action="TeacherImageAdd" enctype="multipart/form-data">
	<input type="hidden"  name="id" value='<%=request.getParameter("id")%>'>
	<table border="0" style="width:10%;height30%;background-color:#79cdef ;margin:auto;">
		...
		<tr style="width:90%;height20%;align:center">	
			<td><button type="submit" class="btn btn-primary" style="width:260px;">修改图片</button></td>
		</tr>
