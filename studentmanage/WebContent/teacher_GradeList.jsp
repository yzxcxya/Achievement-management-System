...
<body>
<div class="x-nav"> <span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>学生成绩管理</cite></a> </span> <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="javascript:location.replace(location.href);" title="刷新"><i class="layui-icon" style="line-height:30px">?</i></a> </div>
<div class="x-body">
  <form class="layui-form x-center" name="frm" action="teacher_GradeList" style="width:85%" method="post">
  ...
  <div class="tools">
    <ul class="toolbar">
      ...
      <li onclick="user_management_add('添加用户','teacher-GradeAdd.jsp','600','500')"><span><img src="images/t01.png" /></span>添加</li>
