...
<center>
<form role="form" name="frm" method="post" action="ImageAdd" enctype="multipart/form-data">
	...
	<table border="0" style="width:10%;height30%;background-color:#79cdef">
		<tr style="width:90%;height80%">
			<td  style="width:100%;heigth:60%">
				<image src="<% if(request.getParameter("img").length()==0){%>images\TX.jpg<%}else{ %>image\<%=request.getParameter("img") %><%}%>" id="image" name="images" class="img-thumbnail" style="width:100%;heigth:100%;"></image>
			</td>
		</tr>
		...
		<tr style="width:90%;height20%">
			<td  align="center">支持gif,png,jpg类型的图片</td>
		</tr>
